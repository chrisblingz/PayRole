...
namespace PayRole.Persistence.Migrations
{
    ...
    [Migration("20200312232712_ModifySLCColumnInPaymentRecordTable")]
    partial class ModifySLCColumnInPaymentRecordTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayRole.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayRole.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("Overtimearnings")
                        .HasColumnType("money");
            ...
            modelBuilder.Entity("PayRole.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayRole.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayRole.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayRole.Entity.TaxYear", "TaxYear")
                        .WithMany()
